...
with open('./video_food_shopping_data.pickle', 'rb') as f:
...
plt.title("Confusion Matrix - Food & Shopping Classifier")
plt.tight_layout()
plt.show()

# Save the trained model
with open('video_food_shopping_model.p', 'wb') as f:
    pickle.dump({'model': model, 'classes': word_classes}, f)

print("💾 Model trained and saved as 'video_food_shopping_model.p'")
